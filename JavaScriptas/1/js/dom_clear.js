...
const col = document.querySelector('.stulp');
const row = document.querySelector('.eil');
const button = document.querySelector('button');
button.addEventListener('click', ()=>{
    document.querySelector('.tableselect').appendChild(document.createElement('h3'));
    document.querySelector('h3').textContent = "Lentele";
    document.querySelector('.tableselect').appendChild(document.createElement('table'));
    for(let i=0;i<document.querySelector('.eil').value;i++){
        let tr = document.createElement('tr');
        for(let i=0;i<document.querySelector('.stulp').value;i++){
    ...
    document.querySelector('table').classList = 'table table-bordered';
});
